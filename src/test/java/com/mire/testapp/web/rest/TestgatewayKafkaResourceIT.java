...
import com.mire.testapp.service.TestgatewayKafkaConsumer;
...
public class TestgatewayKafkaResourceIT {
    ...
    @Autowired
    private TestgatewayKafkaProducer producer;

    @Autowired
    private TestgatewayKafkaConsumer consumer;
    ...
    @BeforeEach
    public void setup() {
        TestgatewayKafkaResource kafkaResource = new TestgatewayKafkaResource(producer);
    ...
    public void producedMessageHasBeenConsumed() throws Exception {
        restMockMvc.perform(post("/api/testgateway-kafka/publish?message=test"))
